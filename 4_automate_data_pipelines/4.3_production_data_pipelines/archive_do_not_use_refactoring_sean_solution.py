"""
This is the instructor Sean Murdock's solution, which I won't use because:

1. "* *kwargs" is a typo he repeats in other dags, plus i believe there's no need for args or kwarsgs here at all. 

2. he defines functions for 4 tasks, calls 3 of them, throws in 2 new tasks, then calls that 4th task from before. this feels messy and not intuitive.

3. [find_riders_under_18_task, how_often_bikes_ridden_task, create_station_count_task] >> drop_oldest_task
these 3 tasks don't depend on drop_oldest_task. this will unnecesserily slow down the dag.
"""
...
#
    ...
    [find_riders_under_18_task, how_often_bikes_ridden_task, create_station_count_task] >> drop_oldest_task
