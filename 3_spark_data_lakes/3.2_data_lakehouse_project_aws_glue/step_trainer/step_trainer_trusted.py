...
StepTrainerLanding_node1745950128503 = glueContext.create_dynamic_frame.from_catalog(database="db-milenko", table_name="step_trainer_landing", transformation_ctx="StepTrainerLanding_node1745950128503")
...
'''
Join_node1745950130171 = sparkSqlQuery(glueContext, query = SqlQuery0, mapping = {"stl":StepTrainerLanding_node1745950128503, "cc":CustomerCurated_node1745950128256}, transformation_ctx = "Join_node1745950130171")
